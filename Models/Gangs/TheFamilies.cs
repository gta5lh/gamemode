...
namespace Gamemode
{
    ...
    public class TheFamilies : Gang
    {
        ...
        public TheFamilies()
        {
            ...
            this.CarMarker = new Marker(new Vector3(-25, -1433, 30.65), this.GangColor, (MarkerType)36, "Car", new CarSelectionEvent(GangUtil.NpcIdTheFamilies, CarSelection, ColorClientSide));
            this.ItemMarker = new Marker(new Vector3(-10, -1445, 30.75), this.GangColor, (MarkerType)41, "Weapon", new ItemSelectionEvent(GangUtil.NpcIdTheFamilies));

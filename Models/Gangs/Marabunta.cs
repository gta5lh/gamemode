...
namespace Gamemode
{
    ...
    public class Marabunta : Gang
    {
        ...
        public Marabunta()
        {
            ...
            this.CarMarker = new Marker(new Vector3(1371.9, -1519.2, 57.52), this.GangColor, (MarkerType)36, "Car", new CarSelectionEvent(GangUtil.NpcIdMarabunta, CarSpawn, ColorClientSide));
            this.ItemMarker = new Marker(new Vector3(1384.2, -1521.7, 57.53), this.GangColor, (MarkerType)41, "Weapon", new ItemSelectionEvent(GangUtil.NpcIdMarabunta));

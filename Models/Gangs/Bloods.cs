...
namespace Gamemode
{
    ...
    public class Bloods : Gang
    {
        ...
        public Bloods()
        {
            ...
            this.CarMarker = new Marker(new Vector3(487, -1314, 29.2), this.GangColor, (MarkerType)36, "Car", new CarSelectionEvent(GangUtil.NpcIdBloods, CarSelection, ColorClientSide));

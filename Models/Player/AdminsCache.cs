...
namespace Gamemode.Models.Player
{
    public class AdminsCache
    {
        ...
        public static void ThreadSafeTriggerClientEvent(string eventName, params object[] args)
        {
            foreach (long adminStaticId in Admins.Keys)
            {
                CustomPlayer admin = PlayerUtil.GetByStaticId(adminStaticId);
                NAPI.ClientEventThreadSafe.TriggerClientEvent(admin, eventName, args);
            }
        }
    }
}

...
namespace Gamemode.Game.Gang
{
	...
	public static class Util
	{
		...
		public static readonly Dictionary<long, string> GangReadableNameById = new()
		{
			{ NpcIdBloods, "Bloods" },
			{ NpcIdBallas, "Ballas" },
		...
		public static readonly Dictionary<long, string> GangNameById = new()
		{
			{ NpcIdBloods, "bloods" },
			{ NpcIdBallas, "ballas" },
		...
		public static readonly Dictionary<string, long> GangIdByName = new()
		{
			{ "bloods", NpcIdBloods },
			{ "ballas", NpcIdBallas },
		...
		public static readonly Dictionary<string, Color> GangColorByName = new()
		{
			{ "ballas", Ballas.Color },
			{ "bloods", Bloods.Color },
		...
		public static readonly Dictionary<long, Spawn> CarSpawnByGangId = new()
		{
		...
		public static readonly Dictionary<long, long> RewardByRank = new()
		{
			{ 1, 10 },
			{ 2, 20 },
			{ 3, 30 },
		...
		public static readonly Dictionary<long, long> SalaryByRank = new()
		{
			{ 1, 400 },
			{ 2, 500 },
			{ 3, 600 },
		...
		public static readonly Dictionary<long, ICollection<Weapon>> WeaponsByGangId = new()
		{
			{
